...
export function CommunityCardLoader() {
    return (
        <Card className="flex flex-col h-fit justify-start items-start md:flex-row w-full bg-slate-100 animate-pulse md:items-center p-4 rounded-2xl gap-6">
