...
export default function ProfileNavItem () {
    ...
    return (
        <div className={`flex flex-row px-8 py-4 justify-between rounded-lg cursor-pointer ${isOpen ? "bg-gray-100" : "bg-white"}`} onMouseEnter={() => setIsOpen(true)} onMouseLeave={() => setIsOpen(false)}>
