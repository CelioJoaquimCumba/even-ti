...
export default function ProfileNavItem () {
    ...
    return (
        <div className={`flex flex-row px-8 py-4 justify-between w-96 rounded-lg cursor-pointer ${isOpen ? "bg-secondary" : "bg-background"}`} onMouseEnter={() => setIsOpen(true)} onMouseLeave={() => setIsOpen(false)}>
